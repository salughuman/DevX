...
const Footer = () => {
  return (
    <footer className="w-full py-5 sm:py-10 px-4 bg-primary-100"> 
      <div className="flex flex-col-reverse sm:flex-row md:justify-between lg:justify-around">
        <div className="relative mt-14 sm:mt-0 px-5 flex flex-col justify-center items-center text-white">
          ...
          <h1 className="font-title text-4xl text-center text-white font-semibold mt-auto">LineTech</h1>
          ...
          <div className="mt-auto flex flex-col items-center">
            ...
            <span className="py-4 text-xs">&copy;2023, DevX Solutions Rights Reserved.</span>
          </div>
        ...
        <div className="grid grid-cols-2 gap-5 text-white">
          ...
          <div className="col-span-2 md:col-span-1 pb-0 md:py-3 px-4">
            <nav className="flex justify-around md:flex-col md:gap-y-4 text-lg font-Raleway font-medium list-none">
              <li><a href="#link" className="hover:text-gray-400">Home</a></li>
              <li><a href="#link" className="hover:text-gray-400">Solutions</a></li>
              <li><a href="#link" className="hover:text-gray-400">Pricing</a></li>
          ...
          <div className="col-span-2 md:col-span-1 pb-0 md:py-3 px-4 flex flex-col items-center sm:items-start">
            <h3 className="pb-1.5 md:pb-4 text-xl text-white font-Raleway font-bold tracking-wide">Address</h3>
            <p className="md:w-48 text-center sm:text-left text-lg md:text-xl">eden orcahrd, faisalbad</p>
          </div>
          ...
          <div className="col-span-2 md:col-span-1 pb-0 md:py-3 px-4 flex flex-col items-center sm:items-start">
            <p className="inline-flex justify-center sm:justify-start text-sm text-white font-medium">
              ...
              <a href="#email">team@devxsolutions.co</a>
            </p>
          </div>
  
          <div className="col-span-2 md:col-span-1 pb-0 md:py-3 px-4 flex flex-col items-center sm:items-start">
            <p className="inline-flex justify-center items-center sm:justify-start text-sm text-white font-bold">
