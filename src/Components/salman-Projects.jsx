...
//         <motion.div
//           className="sm:grid sm:grid-cols-3 p-20"
//           variants={container}
//           initial="hidden"
//           whileInView="visible"
//           viewport={{ once: true, amount: 0.2 }}
//         >
//           <div className="flex justify-center text-center items-center p-10 bg-red-900 max-w-[600px] max-h-[600px] text-2xl font-playfair font-semibold">
