...
import sannan from "../../public/sannan.png";
import salman from "../../public/salman.png";
import asim from "../../public/asim.png";
import devx from "../../public/devx-logo.webp";
        ...
        <div class="grid grid-cols-3 gap-4">
          <div className="text-center w-auto text-gray-500 dark:text-gray-400 hover:bg-green-700 p-8 rounded-2xl">
            ...
            <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-300 dark:text-white">
              <a href="#">Sannan Tariq</a>
            </h3>
            <p className="text-gray-300">Senior Backend Developer</p>
          ...
          <div className="text-center w-auto text-gray-500 dark:text-gray-400 hover:bg-green-700 p-8 rounded-2xl">
            ...
            />
            <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-300 dark:text-white">
              <a href="#">Khalil-ur-Rehman</a>
            </h3>
            <p className="text-gray-300">Senior HR</p>
            <ul className="flex justify-center mt-4 space-x-4">
              <li>
                <a
                  href="#"
          ...
          <div className="text-center w-auto text-gray-500 dark:text-gray-400 hover:bg-green-700 p-8 rounded-2xl">
            ...
            />
            <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-300 dark:text-white">
              <a href="#">Asim Hafeez Khan</a>
            </h3>
            <p className="text-gray-300">Hiring Manager</p>
            <ul className="flex justify-center mt-4 space-x-4">
              <li>
                <a
                  href="#"
