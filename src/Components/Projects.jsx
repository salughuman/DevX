...
const Project = ({ title }) => {
  ...
  return (
    <motion.div variants={projectVariant} className="relative">
      ...
      <img src={`../img/${projectTitle}.jpeg`} alt={projectTitle} />
    </motion.div>
  );
};
    ...
    <section className="pt-24 pb-48 bg-primary-200">
      ...
      <div className="flex justify-center">
        ...
        >
          ...
          <div
            className="flex justify-center text-center items-center p-10 bg-red-900 max-w-[400px] max-h-[400px] text-2xl font-playfair font-semibold"
          >
